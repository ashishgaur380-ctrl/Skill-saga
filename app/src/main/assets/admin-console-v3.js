...
window.ssAdminBootModules=function(){['admin-console-core.js','admin-console-content.js','admin-console-community.js','admin-console-operations.js','admin-console-competition-control.js'].forEach(function(src){var s=document.createElement('script');s.src=src;s.async=false;s.onload=function(){if(window.ssAdminV3)window.admin=window.ssAdminV3};s.onerror=function(){console.warn('Admin module load failed',src)};(document.head||document.documentElement).appendChild(s)})};
