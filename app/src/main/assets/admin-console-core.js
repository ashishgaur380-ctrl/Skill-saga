...
function loadAdminModule(src){
  ...
  __ssAdminModulePromises[src]=new Promise(function(resolve,reject){
    var existing=document.querySelector('script[data-ss-admin-module="'+src+'"]');
    if(existing){
