...
.ss-play-live-title{font-size:15px;font-weight:1000;color:#102653;margin:0 2px 9px}
/* Force six Play modes into two columns; overrides legacy one-column rules. */
#ss-play-live .ss-play-modes{display:grid!important;grid-template-columns:repeat(2,minmax(0,1fr))!important;grid-template-rows:auto!important;grid-auto-flow:row!important;gap:9px!important;width:100%!important;align-items:stretch!important}
#ss-play-live .ss-play-modes .ss-mode{display:flex!important;width:100%!important;min-width:0!important;max-width:none!important;box-sizing:border-box!important;flex-direction:column!important;justify-content:center!important;align-items:center!important;background:#fff;border:1px solid #e1e8f3;border-radius:18px;padding:14px 10px;min-height:105px;box-shadow:0 6px 16px rgba(28,53,98,.06);cursor:pointer}
#ss-play-live .ss-play-modes .ss-mode:nth-child(1){background:#eef5ff!important}#ss-play-live .ss-play-modes .ss-mode:nth-child(2){background:#fff7df!important}#ss-play-live .ss-play-modes .ss-mode:nth-child(3){background:#eaf8f0!important}#ss-play-live .ss-play-modes .ss-mode:nth-child(4){background:#f2edff!important}#ss-play-live .ss-play-modes .ss-mode:nth-child(5){background:#fff0f4!important}#ss-play-live .ss-play-modes .ss-mode:nth-child(6){background:#e9f4ff!important}
#ss-play-live .ss-play-modes .ss-mode .i{font-size:27px}#ss-play-live .ss-play-modes .ss-mode b{font-size:11px;color:#172542;margin-top:5px}#ss-play-live .ss-play-modes .ss-mode small{font-size:8px;line-height:1.3;color:#71809a;text-align:center}
